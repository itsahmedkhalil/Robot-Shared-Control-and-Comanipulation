...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_communication-msg:<Num> is deprecated: use imu_communication-msg:Num instead.")))

(cl:ensure-generic-function 'accX-val :lambda-list '(m))
(cl:defmethod accX-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_communication-msg:accX-val is deprecated.  Use imu_communication-msg:accX instead.")
  (accX m))

(cl:ensure-generic-function 'accY-val :lambda-list '(m))
(cl:defmethod accY-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_communication-msg:accY-val is deprecated.  Use imu_communication-msg:accY instead.")
  (accY m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Num>)))
  ...
  (cl:format cl:nil "float64 accX~%float64 accY~%~%~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Num)))
  "Returns full string definition for message of type 'Num"
  (cl:format cl:nil "float64 accX~%float64 accY~%~%~%~%~%~%"))
